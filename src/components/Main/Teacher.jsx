...
export default function Teacher() {
  const {teacherData, handlerSubmit } = useContext(TeacherContext);
  return (
          ...
          <table className="students__tabel">
            <thead className="students__thead">
              <tr className="students__tr">
                <th className="students__th">
                  <button className="students__thbtn" id="namebtn">
                    #{" "}
                  </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn" id="mailbtn">
                    Ismi
                  </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn" id="numbtn">
                    Guruh{" "}
                  </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn" id="depabtn">
                    Telefon Raqam
                  </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn">Guruhlar </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn">Vaqt </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn">holati </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn">Hisob holati </button>
                </th>
                <th className="students__th">
                  <button className="students__thbtn"></button>
                </th>
              </tr>
            </thead>
              ...
              {teacherData.map((item, key) => {
                return (
                  <tr key={key + 782} className="students__tr">
                    ...
                    <td className="students__td">
                      <button className="students__error">
                        <i className="bx bxs-error-circle"></i>
                      </button>
                      <button className="students__edit">
                        <i className="bx bxs-pencil" />
                      </button>
                      <button className="students__xbtn">
                        <i className="bx bx-x" />
                      </button>
                    </td>
                  </tr>
